...
# Obtain sequence data and generate reads
...
# art_illumina -sam -i Enterobacteriophage_lambda.fa -mp -l 120 -f 80 -m 2500 -s 30 -o lamda
# samtools view -bS lamda.sam > lamda.bam

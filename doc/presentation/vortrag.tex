...
\setcounter{framenumber}{1}
  ...
  \begin{columns}
    ...
    \begin{column}{.45\textwidth}
      \begin{center}
        \begin{figure}[t]
          \epsfig{scale=0.5, file=figures/Scaffolding}
        \end{figure}
        \vspace{.75cm}
        \begin{figure}[t]
          \epsfig{scale=0.55, file=figuresScaffolding_2}
        \end{figure}
      \end{center}
    \end{column}
  \end{columns}
...
\begin{frame}
  ...
  \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{figures/Scaffolding_3.pdf}
  \end{itemize}
\end{frame}

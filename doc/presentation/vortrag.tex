...
\begin{frame}
  ...
  \begin{itemize} % SK: basierend auf Konzepten und Infrastruktur GenomeTools
...
\begin{frame}
  ...
  \begin{itemize} %SK: flowchart
  \item Eingabe:
    \begin{itemize}
    \item Contigs
    \item Distanzinformationen
    \item A-Statistik % SK: Sinn erläutern!
    \end{itemize}
  \item Ausgabe:
    \begin{itemize}
    \item Scaffolds

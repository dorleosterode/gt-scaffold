...
\begin{frame} %SK: Graph als Hintergrund, Zahlen motivieren, NP vollständig näher definieren
  ...
  \item Scaffold Graph:
    ...
    \end{itemize}
  \item Ermittlung eines optimalen Pfades in jeder Zusammenhangskomponente des 
        Scaffold Graphen 
...
\begin{frame}
  ...
  \begin{itemize}
    \item Aufklärung Algorithmus / Datenformate
    \item Entwurf der Datenstrukturen
    \item Implementierung
    \item Auswählen von Testdaten
    \item Evaluation, Dokumentation
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item Makierung der ausgehenden Kanten des Contigs
    \end{itemize}
    \item Grichtete Zyklen
    \begin{itemize}

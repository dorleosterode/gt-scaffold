...
\begin{frame}
  \frametitle{Bestimmung des besten Pfades}
  %% teil von s_cerevisae datensatz unter /work/stud2013/sdang/scaffolding/s_cerevisiae
  \begin{center}
...
\begin{frame}
  ...
  \item Gründe für neue Implementation
    \begin{itemize}
    \item geringerer Speicherplatzverbrauch, ähnliche Laufzeit
       für gt Scaffolder im Vergleich zu SGA Scaffold bei gleicher Güte
       der Ergebnisse
  ...
  \begin{tikzpicture}[node distance=.75cm]
    ...
    \node[prog, fill=red!40] (bindex) {index};
...
\begin{frame}
  ...
  \item was wir noch alles machen muessen (kann erst am ende
    ausgefuellt werden)
  \item gt Scaffolder in \textit{GenomeTools} integrieren
  \item weitere Optionen implementieren
  \item Anbindung an \textit{ReadJoiner}

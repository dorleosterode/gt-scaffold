...
\begin{frame} % SK: Gegenüberstlellung einfügen
  \frametitle{Testbedingungen: gt Scaffold vs. SGA Scaffold}
  \begin{itemize}
    ...
    \item Workstation: Core-i7 @ 3.10GHz (8 Kerne), 8GB RAM, Linux 64 bit
  \end{itemize}
\end{frame}

\begin{frame} % SK: Abstände überarbeiten
  \frametitle{Pipeline: gt Scaffold vs. SGA Scaffold}
  \begin{columns}
    \begin{column}{.45\textwidth}
      SGA Pipeline: C++, Perl, Python
      \begin{tikzpicture}[node distance=.75cm and 2cm]
        ...
        \node[prog, right of=prep, fill=red!40] (bindex) {index};
    ...
    \begin{column}{.45\textwidth}
      ...
      \begin{tikzpicture}[node distance=.75cm]
        ...
        \node[prog, right of=prefilter] (scaffold) {scaffold};
...
\begin{frame}
  ...
  \begin{itemize}
    \item Entwicklung eines Scaffolding-Programms angelehnt an SGA
    \begin{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Implementierung benutzerdefinierter Optionen

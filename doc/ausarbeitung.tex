...
Ergebnisse der beiden Programme zu erhalten.
...
\item Bei der Konstruktion des Graphen werden zwischen zwei Knoten
  ...
  größten Standardabweichung gewählt. Die Güte dieser Strategie wurde
  exemplarisch evaluiert (vgl. Abschnitt~\ref{sec: wunderlich_assert}).\\

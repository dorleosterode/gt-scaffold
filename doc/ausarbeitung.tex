...
\usepackage{graphicx}
\usepackage{placeins}
\usepackage{siunitx}  % Einheiten mit korrekten Leerzeichen
...
\todo{Strangorientierung fehlt, SD: Worauf bezieht sich dessen im vorletzten
Satz?}
...
Datenstruktur, die in der aktuellen Implementation von gt Scaffolder in dem

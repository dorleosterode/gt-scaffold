...
aufgefüllt. \todo{schreiben, das für jeden Contig im Scaffold ein
  String konstruiert wird und so} Im Folgenden werden die einzelnen
...
Format (\todo{referenz auf die github-seite, wo das erklaert ist})
ausgegeben. Dieser String-Graph wird mit einem Python-Skript in das
\textit{.spm} Format umgeschrieben.
...
Smith-Waterman-Algorithmus für lokale Alignments \todo{Referenz?} verwendet. Der
